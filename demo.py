...
if __name__ == '__main__':
    ...
    image_path = "sample.jpg"   # ★ここにサンプル画像を置く
    ...
    result, _ = visualizer.run_on_opencv_image(image, "dog")  # 例：dog という単語でグラウンディング

    imshow(result, "output.jpg")
